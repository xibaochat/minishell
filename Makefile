...
#    Updated: 2020/10/03 02:14:06 by maobe            ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
SRC = main.c display_ascii_dude.c env.c pwd.c cd.c ft_tablen.c \
	cd_options.c manage_cd_opt.c change_env_var_value.c export.c check_export_var_val.c
